...
{
    [AddComponentMenu("Layout/Spine Aspect Ratio Fitter", 143)]
    [ExecuteAlways]
    ...
    /// </summary>
    public class SpineAspectRatioFitter : UIBehaviour, ILayoutSelfController
    {
        /// <summary>
        ...
        private float m_AspectScale = 1;

        /// <summary>
        /// The native size of spine designed.
        /// </summary>
        [SerializeField] private Vector2Int m_NativeSize = new Vector2Int(100, 100);
        ...
        protected SpineAspectRatioFitter() { }
        ...
        private void UpdateRect()
        {
            ...
            m_NativeSize.x = Mathf.Clamp(m_NativeSize.x, 1, 2048);
            m_NativeSize.y = Mathf.Clamp(m_NativeSize.y, 1, 2048);
            float x = rectTransform.rect.width / m_NativeSize.x;
            float y = rectTransform.rect.height / m_NativeSize.y;
            m_AspectScale = Mathf.Max(x, y);
            rectTransform.localScale = new Vector3(m_AspectScale, m_AspectScale, rectTransform.localScale.z);
        }
