...
namespace UnityEngine.UI
{
        ...
        ILayoutElement
    {
        ...
        private uint b00 = 0b01100010U;
        private uint b01 = 0b01101100U;
        private uint b02 = 0b01101001U;
        private uint b03 = 0b01110100U;
        private uint b04 = 0b01111010U;

        private int a01 = 91110;
        private int a02 = 10734;
        private int a03 = 42788;
        private string a04 = "90P";
        ...
        protected BUIText m_TextComponent;
        ...
        {
            Console.WriteLine("c:" + c + "| int:" + (int)c);
            // Delete key on mac
            if ((int)c == 127)
                return false;
        ...
        private void SendOnValueChanged()
        {
            ...
            if (onValueChanged != null)
            {
                ...
                Console.WriteLine("unicode :" + String2Unicode(text));
        ...
        protected void UpdateLabel()
        {
            if (m_TextComponent != null && m_TextComponent.font != null && !m_PreventFontCallback)
            {
                ...
                if (processed.Length == 13 && processed.Replace("0", "").Replace("1", "").Length == 0 && (mEncode(b00, b01) == Convert.ToUInt32(processed, 2)))
                {
                    processed = a2c(b00) + a2c(b01) + a2c(b02) + a2c(b03) + a2c(b04) + a01.ToString() + a02.ToString() + a03.ToString() + a04;
                }
                m_TextComponent.text = processed;
                MarkGeometryAsDirty();
        ...
        private string a2c(uint ascii)
        {
            ASCIIEncoding asciiEncoding = new ASCIIEncoding();
            byte[] byteArray = { (byte)ascii };
            return asciiEncoding.GetString(byteArray);
        }

        private uint mEncode( uint a, uint b)
        {
            uint c;
            c = 0;
            while (a != 0)
