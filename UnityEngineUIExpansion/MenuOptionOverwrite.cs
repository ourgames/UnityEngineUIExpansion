...
namespace UnityEditor.UI
{
    ...
    static internal class MenuOptionsOverwrite
    {
        ...
        static private DefaultControlsOverwrite.Resources s_StandardResources;

        static private DefaultControlsOverwrite.Resources GetStandardResources()
        {
        ...
        private static void PlaceUIElementRoot(GameObject element, MenuCommand menuCommand)
        {
            ...
            if (parent.GetComponentInParent<Canvas>() == null)
            {
                ...
                GameObject canvas = MenuOptionsOverwrite.CreateNewUI();
        ...
        [MenuItem("GameObject/UI/BUI Text", false, 2000)]
        ...
        static public GameObject GetOrCreateCanvasGameObject()
        {
            ...
            return MenuOptionsOverwrite.CreateNewUI();
        }
